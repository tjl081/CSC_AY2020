...
using CSC_AY2020_Task3.Models;
using CSC_AY2020_Task3.Providers;
using CSC_AY2020_Task3.Results;
...
namespace CSC_AY2020_Task3.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        //run thid method before running the register method
        // POST api/Account/Verify
        [AllowAnonymous]
        [Route("Verify")]
        public async Task<bool> Verify(CaptchaModel model)
        {
